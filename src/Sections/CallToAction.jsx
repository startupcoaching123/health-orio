...
const CallToAction = ({ theme }) => {
  ...
  const outerBg = isLight ? 'bg-slate-50' : 'bg-[#F5AD3D]';
  ...
  return (
    <section 
      ref={sectionRef}
      className={`relative w-full py-24 px-4 md:px-8 lg:px-12 ${outerBg} transition-colors duration-700 overflow-hidden flex items-center justify-center`}
    >
      ...
      >
        ...
        <div className="absolute inset-0 opacity-60 mix-blend-soft-light bg-[radial-gradient(circle_at_70%_30%,rgba(245,173,61,0.4),transparent_50%)]"></div>
        ...
        <div className="relative z-10 p-8 md:p-12 lg:p-16 flex flex-col md:flex-row items-center justify-between gap-10 text-center md:text-left">
          ...
          <div className="flex-shrink-0">
            <button className="group relative inline-flex items-center gap-3 px-8 py-4 bg-[#F5AD3D] text-[#1F2022] rounded-full text-lg font-bold shadow-[0_0_25px_rgba(245,173,61,0.4)] hover:shadow-[0_0_40px_rgba(245,173,61,0.6)] hover:scale-105 transition-all duration-300 active:scale-95">
