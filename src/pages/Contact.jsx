...
const ContactAssessment = ({ theme }) => {
   ...
   const inputBg = isLight ? 'bg-white border-gray-200 focus:border-[#1F2022]' : 'bg-[#2A2B2E] border-white/10 focus:border-[#E6EBE0]';
            ...
            <div className={`relative transition-all duration-1000 delay-300 ${isVisible ? 'opacity-100 translate-x-0' : 'opacity-0 translate-x-12'}`}>
               ...
               <div className={`relative p-8 md:p-10 rounded-[2.5rem] shadow-2xl overflow-hidden border ${isLight ? 'bg-white border-gray-100' : 'bg-[#151618] border-white/10'}`}>
                  ...
                  <form className="space-y-6">
                     ...
                     {/* Submit Button */}
                     <button type="button" className={`w-full py-4 rounded-xl font-bold text-lg flex items-center justify-center gap-2 hover:scale-[1.02] active:scale-[0.98] transition-all shadow-xl ${isLight ? 'bg-[#1F2022] text-white' : 'bg-[#E6EBE0] text-[#1F2022]'}`}>
