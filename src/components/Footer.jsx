          ...
          <div className="flex flex-col justify-center">
             ...
             <form className="flex flex-col sm:flex-row gap-3">
                <input 
                  ...
                  className="flex-grow bg-[#1A1A1A] border border-white/10 rounded-xl px-5 py-4 text-white placeholder-zinc-600 focus:outline-none focus:border-[#F5AD3D] focus:ring-1 focus:ring-[#F5AD3D] transition-all"
                />
                <button className="bg-[#F5AD3D] text-[#0A0A0A] px-8 py-4 rounded-xl font-bold hover:bg-white transition-colors flex items-center justify-center gap-2 shadow-[0_0_20px_rgba(245,173,61,0.2)]">
