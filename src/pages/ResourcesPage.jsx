         ...
         <div className="max-w-7xl mx-auto">
            ...
            <div className={`text-center mb-20 transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
               ...
               <h1 className="text-4xl md:text-6xl font-black tracking-tight mb-6">
                  Insights & <span className="text-[#F5AD3D]">Guides</span>
               </h1>
                 ...
                 `}
                  ...
                  >
                     ...
                     <div className="flex items-center justify-between mb-8">
                        ...
                        {item.isGated ? (
                           <div className={`flex items-center gap-1.5 px-3 py-1 rounded-full bg-current/5 text-xs font-bold opacity-60 group-hover:${bgAccent} group-hover:${accentIcon} group-hover:opacity-100 transition-all`}>
                     ...
                     <div className="flex items-start gap-6 mb-6">
                        ...
                        <div>
                           <h3 className={`text-2xl font-bold leading-tight mb-2 group-hover:${accentColor} transition-colors`}>{item.title}</h3>
                        </div>
                     </div>
               ...
               <div className="relative z-10 max-w-2xl mx-auto">
                  ...
                  <div className="flex flex-col sm:flex-row gap-4 justify-center">
                     <input
                        ...
                        className={`px-6 py-4 rounded-full text-lg outline-none w-full sm:w-80 border-2 border-transparent focus:border-current transition-colors ${isLight ? 'bg-white/10 text-white placeholder-white/40' : 'bg-[#1F2022]/5 text-[#1F2022] placeholder-black/40'}`}
                     />
                     <button className={`px-8 py-4 rounded-full font-bold text-lg flex items-center justify-center gap-2 hover:scale-105 transition-transform shadow-xl ${isLight ? 'bg-[#E6EBE0] text-[#1F2022]' : 'bg-[#1F2022] text-[#E6EBE0]'}`}>
