...
const WhatWeSolvePage = ({ theme }) => {
         ...
         <section ref={ref} className={`relative min-h-screen w-full ${bgClass} ${textClass} flex flex-col justify-center py-24 px-6 overflow-hidden`}>
            ...
            <div className="relative z-10 max-w-7xl mx-auto w-full grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
               ...
               <div className={`transition-all duration-1000 ${isVisible ? 'opacity-100 translate-x-0' : 'opacity-0 -translate-x-10'}`}>
                  <div className={`inline-flex items-center gap-2 px-3 py-1 rounded-full bg-[#F5AD3D]/10 text-[#F5AD3D] font-bold text-xs uppercase tracking-widest mb-6`}>
                     <Unplug size={14} /> The Root Cause
                  </div>
                  <h1 className="text-4xl md:text-6xl lg:text-7xl font-black tracking-tight leading-tight mb-8">
                     Stop Fixing Symptoms. <br />
                     <span className="text-[#F5AD3D]">Solve the Crisis.</span>
                  </h1>
   ...
   const FinancialSection = () => {
      ...
      const cardBg = isLight ? 'bg-white/5' : 'bg-black/10';
